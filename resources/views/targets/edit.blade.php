            ...
            <form method="POST" action="{{ route('targets.update', $target->id) }}" class="space-y-8 relative">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center px-4 bg-white border-2 border-[#c5d89d]/20 focus-within:border-[#c5d89d] focus-within:ring-4 focus-within:ring-[#c5d89d]/10 rounded-2xl transition-all shadow-sm overflow-hidden group">
                        ...
                        <input type="number" id="target_amount" name="target_amount" step="0.01" value="{{ old('target_amount', $target->target_amount) }}" required placeholder="0.00"
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center px-4 bg-white border-2 border-[#c5d89d]/20 focus-within:border-[#c5d89d] focus-within:ring-4 focus-within:ring-[#c5d89d]/10 rounded-2xl transition-all shadow-sm overflow-hidden group">
                        ...
                        <input type="number" id="current_amount" name="current_amount" step="0.01" value="{{ old('current_amount', $target->current_amount) }}" required placeholder="0.00"
                               style="border: none !important; outline: none !important; box-shadow: none !important;"
                               class="amount-input w-full py-5 px-6 bg-transparent text-[#2d2d2d] text-3xl font-bold focus:ring-0 focus:border-0 focus:outline-none"/>
                    </div>
