            ...
            <form method="POST" action="{{ route('transactions.update', $transaction->id) }}" class="space-y-8 relative">
                ...
                <div class="space-y-3">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <label class="relative flex items-center justify-center p-4 bg-white border-2 {{ $currentType == 'income' ? 'border-[#c5d89d] bg-[#c5d89d]/10' : 'border-[#c5d89d]/30' }} rounded-2xl cursor-pointer hover:border-[#c5d89d] transition-all group">
                        ...
                        <label class="relative flex items-center justify-center p-4 bg-white border-2 {{ $currentType == 'expense' ? 'border-[#d9a3a3] bg-[#d9a3a3]/10' : 'border-[#d9a3a3]/30' }} rounded-2xl cursor-pointer hover:border-[#d9a3a3] transition-all group">
