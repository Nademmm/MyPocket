        ...
        >
            ...
            <nav class="flex-1 overflow-y-auto py-4">
                ...
                <ul class="space-y-1 px-3">
                    ...
                    <li>
                        <a href="{{ route('badges.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl text-[#2d2d2d] hover:bg-[#c5d89d]/20 hover:text-[#6b7854] transition-all duration-200 group {{ request()->routeIs('badges.*') ? 'bg-[#c5d89d]/20 text-[#6b7854]' : '' }}">
                            <svg class="w-5 h-5 flex-shrink-0 text-[#89986d] group-hover:text-[#6b7854] group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L1 12l7.714-2.143L11 3z"></path>
                            </svg>
                    ...
                    <li>
                        <a href="{{ route('savings-arena.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl text-[#2d2d2d] hover:bg-[#c5d89d]/20 hover:text-[#6b7854] transition-all duration-200 group {{ request()->routeIs('savings-arena.*') ? 'bg-[#c5d89d]/20 text-[#6b7854]' : '' }}">
                            <svg class="w-5 h-5 flex-shrink-0 text-[#89986d] group-hover:text-[#6b7854] group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                            </svg>
                            <span class="font-medium">Savings Arena</span>
                        </a>
                    </li>
